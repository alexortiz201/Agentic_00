...
Topics in scope but **not yet written**: interface design, coupling and cohesion, separation of concerns. They are named so a reader can tell the difference between missing and hidden -- if you want one of them, it is not here yet.
