...
5. Classify findings using [verification dispositions](../04_VERIFICATION.md). Supply exact file/line or behavioral evidence and a targeted repair request. Report unresolved findings consistently; never claim clean approval while listing blockers.
